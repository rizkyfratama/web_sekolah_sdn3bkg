...
class Media {
  ...
  createTitle() {
    this.title = new Title({
      ...
      font: this.font // Corrected param name
    });
  }
...
export default function CircularGallery({
  ...
  useEffect(() => {
    ...
    const app = new OGLApp(containerRef.current, { items, bend, textColor, borderRadius, font, scrollSpeed, scrollEase });
    return () => {
      app.destroy();
    };
  }, [items, bend, textColor, borderRadius, font, scrollSpeed, scrollEase]);
  
  return <div className={`circular-gallery ${className}`} ref={containerRef} />;
}
